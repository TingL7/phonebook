...
# hash function test version
#plot [:][:0.150]'output.txt' using 2:xtic(1) with histogram title 'original', \
#'' using ($0-0.3):($2+0.001):2 with labels title ' ', \
#'' using 3:xtic(1) with histogram title 'BKDR'  , \
#'' using 4:xtic(1) with histogram title 'RS'  , \
#'' using 5:xtic(1) with histogram title 'DJB'  , \
#'' using 6:xtic(1) with histogram title 'SDBM'  , \
#'' using 7:xtic(1) with histogram title 'JS'  , \
